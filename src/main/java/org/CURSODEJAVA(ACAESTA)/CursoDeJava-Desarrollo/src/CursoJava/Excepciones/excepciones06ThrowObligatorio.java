...
class excepciones06ThrowObligatorio {
    ...
    /**
     * Como es una excepci�n controlada estmos obligados a colocar el trycatch en
     * donde se lllame al m�todo.
     * Siempre hay que colocar la excepcion que puede pasar, no una gen�rica o
     * err�nea.
     */
