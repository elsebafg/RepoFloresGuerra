...
class CrearDirectoriosPorUsuario {
    ...
    public static void main(String[] args) {
        ...
        File carpeta = new File(
                "D:" + File.separator + "Desarrollo" + File.separator + "CursoDeJava" + File.separator + nombreCarpeta);
        ...
        try {
            FileWriter contenidoDelArchivo = new FileWriter("D:" + File.separator + "Desarrollo" + File.separator
                    + "CursoDeJava" + File.separator + nombreCarpeta + File.separator + nombreArchivo + ".txt", true);
